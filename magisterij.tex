...
&\ddd{q}_{2,j}=\ddd{Q}_{3,j}-2\ddd{Q}_{2,j}+\ddd{Q}_{1,j}\textrm{ za }j=0,\ldots,5,\\
...
določene, medtem ko so kontrolne točke $\ddd{P}_{1,j}$ in $\ddd{P}_{2,j}$, 
$j=1,\ldots,4$, proste. 
%\begin{align*}
...
omogoča konstrukcijo $G^1$-zveznih ploskev posebnih oblik, kot je na primer 
"opičje sedlo". \todo{? slika.}
