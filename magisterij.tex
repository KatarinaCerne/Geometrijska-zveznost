...
\nevem{prestavi na kasneje?}Poleg 
...
vektorji, ki nastopajo v zgornjih enačbah, razen vektorjev $\ddd{v}_0$ in $\ddd{v}_4$ 
znani. Enačbi \ref{eq36} in \ref{eq38} enolično določata vrednosti parametrov 
$e_{10}$, $f_{10}$, $e_{11}$ in $f_{11}$. \todo{glej primer g1} 

------------------------------------------

\begin{align*}
  &E_1(v)=p_{10}(1-v)^2+2p_{1m}v(1-v)+p_{11}v^2\\
  &F_1(v)=q_{10}(1-v)+q_{11}v\\
  &E_2(v)=p_{20}(1-v)^2+2p_{1m}v(1-v)+p_{21}v^2\\
  &F_2(v)=q_{20}(1-v)+q_{21}v\\
\end{align*}
...
\end{align*}
$\ddd{\tilde{p}}_0=\ddd{p}_{1,0}$, $\ddd{\tilde{p}_3}=\ddd{p}_{1,5}$
...
\begin{align*}
&\ddd{q}_{1,1}=\frac{1}{5}(3p_{10}\ddd{\tilde{p}}_1+2p_{1m}\ddd{p}_{1,0}+
q_{11}\ddd{z}_0+4q_{10}\ddd{z}_1)\\
&\ddd{q}_{1,2}=\frac{1}{10}(6p_{1m}\ddd{\tilde{p}}_1+3p_{10}\ddd{\tilde{p}}_2+
p_{11}\ddd{p}_{1,0}+4q_{11}\ddd{z}_1+6q_{10}\ddd{z}_2)\\
&\ddd{q}_{1,3}=\frac{1}{10}(3p_{11}\ddd{\tilde{p}}_1+6p_{1m}\ddd{\tilde{p}}_2+
p_{10}\ddd{p}_{1,5}+6q_{11}\ddd{z}_2+4q_{10}\ddd{z}_3)\\
&\ddd{q}_{1,4}=\frac{1}{5}(3p_{11}\ddd{\tilde{p}}_2+2p_{1m}\ddd{p}_{1,5}+
4q_{11}\ddd{z}_3+q_{10}\ddd{z}_4)
\end{align*}

\begin{align*}
5\ddd{q}_{2,1}=&4p_{10}p_{1m}\ddd{p}_{2,0}+p_{10}^2\ddd{p}_{2,5}+p_{10}q_{10}(\ddd{\tilde{p}}_2-\ddd{\tilde{p}}_1)
+(2p_{1m}q_{10}+p_{10}q_{11})\ddd{v}_0+3q_{10}^2\ddd{s}_1+\\
&+2q_{10}q_{11}\ddd{s}_0+\frac{1}{4}(3p_{20}\ddd{\tilde{p}}_1+2p_{2m}\ddd{p}_{1,0}
+q_{21}\ddd{z}_0+4q_{20}\ddd{z}_1)
\end{align*}

\begin{align*}
10\ddd{q}_{2,2}=&(2p_{10}p_{11}+4p_{1m}^2)\ddd{p}_{2,0}+4p_{10}p_{1m}\ddd{p}_{2,5}+
+(p_{10}q_{11}+2p_{1m}q_{10})(\ddd{\tilde{p}}_2-\ddd{\tilde{p}}_1)+\\
&+(2p_{1m}q_{11}+p_{11}q_{10})\ddd{v}_0+p_{10}q_{10}\ddd{v}_4+3q_{10}^2\ddd{s}_2+
6q_{10}q_{11}\ddd{s}_1+q_{11}^2\ddd{s}_0+\\
&+\frac{1}{4}(6p_{2m}\ddd{\tilde{p}}_1+3p_{20}\ddd{\tilde{p}}_2+p_{21}\ddd{p}_{1,0}+
4q_{21}\ddd{z}_1+6q_{20}\ddd{z}_2)
\end{align*}
