...
Parametri $e_0$, $f_0$ in $f_1$ 
so prosti. Edina omejitev, ki velja v tem primeru, je, da mora biti $e_0<0$,
saj bi imel v nasprotnem primeru stik ploskev obliko špice. Če izberemo 
...
ploskev veliko manj omejujoča kot zahteva $C^1$-zveznosti.
...
za določanje oblike, tu dobimo 4 parametre: $e_0$, $e_1$, $f_0$ in $f_1$. S tem 
dobimo nove možnosti za obliko dobljene ploskve. 
Hkrati pa izgubimo nekaj svobode, kar se tiče izbire kontrolnih točk. Kontrolne točke 
