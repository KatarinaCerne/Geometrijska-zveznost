...
% Bx = [0,2,6,8;4,4,4,NaN;5,5,NaN,NaN;6,NaN,NaN,NaN];
% By = [0,1,0,-1;-1,0,1,NaN;-0.5,0.5,NaN,NaN;0,NaN,NaN,NaN];
% Bz = [-2,1,-2,0;1.5,1.5,1.5,NaN;1,1,NaN,NaN;0,NaN,NaN,NaN];
...
trimesh(TRI4,Bx1,By1,Bz1,'Facecolor','none', 'EdgeColor','black');
hold off