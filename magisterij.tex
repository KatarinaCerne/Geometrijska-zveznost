...
Dva izmed teh parametrov sta določena z enačbama \ref{eq18} in \ref{eq19}, 
...
\begin{primer}\label{primer3}
  ...
  Stopnja polinoma $D(v)$ naj bo znova 0, stopnja $F_1(v)$ pa 1. Ker pa želimo 
  več parametrov, ki bodo določali obliko dobljene ploskve, naj bo polinom $E_1(v)$ 
