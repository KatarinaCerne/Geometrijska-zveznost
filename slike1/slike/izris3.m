...
% zSy = [0,0,-6,0;2,2,0,2;4,4,0,4;6,6,10,6];
% zSz = [0,4,-4,0;2,6,0,0;2,6,0,2;0,0,-8,0];

%èe je e1=2
zSx = [-6,-4,-2,0;-6,-4,0,0;-6,-4,0,0;-6,-4,-4,0];
zSy = [0,0,-6,0;2,2,0,2;4,4,0,4;6,6,10,6];
zSz = [0,4,-4,0;2,6,0,0;2,6,0,2;0,0,-12,0];

[Rx,Ry,Rz,Sx,Sy,Sz]=primer2(zRx,zRy,zRz,zSx,zSy,zSz);
