...
Sledi, da je $R_y(x_0,y) = S_y(x_0,y)$. Kot smo že videli \todo{ugh} v poglavju \todo{sklic}, 
...
funkciji $\alpha_1$ in $\beta_1$, kjer je $\alpha_1 \neq 0$ in ima ustrezen predznak, da velja:
