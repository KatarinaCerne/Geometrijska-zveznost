...
Robne kontrolne točke naj bodo torej že vnaprej določene. 
Zanimalo nas bo,  
...
\begin{primer}\label{primer1}
  ...
  % \caption[caption za v kazalo]{Dolg caption pod sliko}
    ...
    {Primer bikubičnih Bézierjevih ploskev iz tenzorskega produkta, ki sta na skupnem robu 
...
\begin{primer}\label{primer3}
  ...
  za 1, torej jo bomo aproksimirali \todo{?} s krivuljo stopnje 2, določeno 
...
Če vpeljemo oznake 
$\tilde{\ddd{p}}_0=\ddd{p}_{1,0}$, $\tilde{\ddd{p}}_1=\ddd{p}_m$ in $\tilde{\ddd{p}}_2=\ddd{p}_{1,3}$, 
