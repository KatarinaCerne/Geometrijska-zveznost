...
\begin{primer}\label{primer1}
  ...
  oziroma 
  $$\ddd{p}_{0,j}=\ddd{q}_{2,j}$$
  za $j=0,\ldots,3$.

  Vidimo torej, da morata biti za dosego $C^1$-zveznosti zlepka ploskev vektorja 
  $\ddd{p}_{0,j}$ in $\ddd{q}_{3,j}$ kolinearna za vsak $j=0,\ldots,3$, poleg tega 
...
\begin{primer}\label{primer2}
  ...
  \begin{align}\label{eq16} 
    D(v)\sum_{j=0}^3 \ddd{q}_{2,j} B_j^3(v) = E_1(v) \sum_{j=0}^3 \ddd{p}_{0,j} B_j^3(v) + 
...
\begin{align*}
  &\sum_{j=0}^3\ddd{q}_{2,j}B_j^3(v) = e_0\sum_{j=0}^3\ddd{p}_{0,j}B_j^3(v) + 
  (f_0(1-v)+f_1v)\sum_{j=0}^2\ddd{z}_jB_j^2(v)=\\
  &=e_0\sum_{j=0}^3\ddd{p}_{0,j}B_j^3(v) + \sum_{j=0}^2\ddd{z}_jf_0{2 \choose j}v^j(1-v)^{3-j} + 
  \sum_{j=0}^2\ddd{z}_jf_1{2 \choose j}v^{j+1}(1-v)^{2-j}=\\
  &=\sum_{j=0}^3e_0\ddd{p}_{0,j}B_j^3(v) + \sum_{j=0}^3\ddd{z}_jf_0{2 \choose j}v^j(1-v)^{3-j} + 
  \sum_{j=1}^3f_1\ddd{z}_{j-1}{2 \choose j-1}v^j(1-v)^{3-j}=\\
  &=\sum_{j=0}^3e_0\ddd{p}_{0,j}B_j^3(v) + \sum_{j=0}^3f_0\ddd{z}_j\frac{3-j}{3}{3 \choose j}v^j(1-v)^{3-j} + 
  \sum_{j=1}^3f_1\ddd{z}_{j-1}\frac{j}{3}{3 \choose j}v^3(1-v)^{3-j}=\\
  &=\sum_{j=0}^3e_0\ddd{p}_{0,j}B_j^3(v) + \sum_{j=0}^3f_0\ddd{z}_j\frac{3-j}{3}B_j^3(v) + 
...
\begin{align*}
\ddd{q}_{2,1}=e_0\ddd{p}_{0,1}+\frac{1}{3}f_1\ddd{z}_0+\frac{2}{3}f_0\ddd{z}_1,&&
\ddd{q}_{2,2}=e_0\ddd{p}_{0,2}+\frac{2}{3}f_1\ddd{z}_1+\frac{1}{3}f_0\ddd{z}_2.
\end{align*}
Najprej opazimo, da za razliko od primera \ref{primer1}, tu ni več potrebe po 
kolinearnosti vektorjev $\ddd{q}_{2,1}$ in $\ddd{p}_{0,1}$ oziroma 
vektorjev $\ddd{q}_{2,2}$ in $\ddd{p}_{0,2}$, zahtevamo le še koplanarnost. 
...
\begin{align*}
\ddd{q}_{3,0}=e_1\ddd{p}_{0,0}+f_1\ddd{z}_0+g\ddd{n},
\end{align*}
kjer $\ddd{n}$ označuje normalo na ravnino, ki jo določajo vektorji $\ddd{q}_{3,0}$, 
$\ddd{p}_{0,0}$ in $\ddd{z}_0$, v točki $\ddd{P}_{0,0}$. Matrika $[\ddd{p}_{0,0},\ddd{z}_0,\ddd{n}]$ 
...
\begin{align*}
e_0=\frac{\det[\ddd{q}_{3,0},\ddd{z}_0,\ddd{n}]}{\det[\ddd{p}_{0,0},\ddd{z}_0,\ddd{n}]},&&
f_0=\frac{\det[\ddd{p}_{0,0},\ddd{q}_{3,0},\ddd{n}]}{\det[\ddd{p}_{0,0},\ddd{z}_0,\ddd{n}]}.
\end{align*}
Na enak način iz enačbe \eqref{eq19} dobimo še parametra $e_1$ in $f_1$
\begin{align*}
  e_1=\frac{\det[\ddd{q}_{2,3},\ddd{z}_2,\ddd{n}]}{\det[\ddd{p}_{0,3},\ddd{z}_2,\ddd{n}]},&&
  f_1=\frac{\det[\ddd{p}_{0,3},\ddd{q}_{2,3},\ddd{n}]}{\det[\ddd{p}_{0,3},\ddd{z}_2,\ddd{n}]}.
\end{align*}
...
lahko dosežemo poljuben kot med vektorjema $q_{2,1}$ in $p_{0,1}$, biti morata samo 
del iste ravnine.  
...
\begin{primer}\label{primer3}
  ...
  s kontrolnimi vektorji $\ddd{p}_{0,0}$, $\ddd{p}_m$ in $\ddd{p}_{0,3}$.   
...
Izrazimo vektor $\ddd{p}_m$ z vektorji $\ddd{p}_{0,i}$, $i=0,\ldots,3$. 
Po formulah za višanje stopnje krivulje velja
\begin{align*}
&\ddd{p}_{0,1}=\frac{2}{3}\ddd{p}_m+\frac{1}{3}\ddd{p}_{0,0},&&
&\ddd{p}_{0,2}=\frac{2}{3}\ddd{p}_m+\frac{1}{3}\ddd{p}_{0,3},
\end{align*}
oziroma
\begin{align}\label{eq17}
\ddd{p}_m=\frac{3}{2}\ddd{p}_{0,1}-\frac{1}{2}\ddd{p}_{0,0}=
\frac{3}{2}\ddd{p}_{0,2}-\frac{1}{2}\ddd{p}_{0,3}.
\end{align}

Če vpeljemo oznake 
$\tilde{\ddd{p}}_0=\ddd{p}_{0,0}$, $\tilde{\ddd{p}}_1=\ddd{p}_m$ in $\tilde{\ddd{p}}_2=\ddd{p}_{0,3}$, 
se enačba \eqref{eq15} v tem primeru preoblikuje v
\begin{align}\label{eq16}
D(v)\sum_{j=0}^3\ddd{q}_{2,j}B_j^3(v)=E_1(v)\sum_{j=0}^2\tilde{\ddd{p}}_jB_j^2(v)+
...
\begin{align*}
  &\sum_{j=0}^3\ddd{q}_{2,j}B_j^3(v)=(e_0(1-v)+e_1v)\sum_{j=0}^2\tilde{\ddd{p}}_jB_j^2(v)
...
\end{align*}
Od tod sledijo pogoji za vektorja $\ddd{q}_{2,1}$ in $\ddd{q}_{2,2}$. 
$$\ddd{q}_{2,1}=\frac{1}{3}(e_1\ddd{p}_{0,0}+2e_0\ddd{p}_m+f_1\ddd{z}_0+2f_0\ddd{z}_1)$$
$$\ddd{q}_{2,2}=\frac{1}{3}(e_0\ddd{p}_{0,3}+2e_1\ddd{p}_m+2f_1\ddd{z}_1+f_0\ddd{z}_2).$$
Če še izrazimo vektor $\ddd{p}_m$ z vektorjema $\ddd{p}_{0,0}$ in $\ddd{p}_{0,1}$ 
oziroma vektorjema $\ddd{p}_{0,2}$ in $\ddd{p}_{0,3}$, dobimo naslednji enačbi:

$$\ddd{q}_{2,1}=e_0\ddd{p}_{0,1}+\frac{1}{3}(e_1-e_0)\ddd{p}_{0,0}+\frac{1}{3}f_1\ddd{z}_0+\frac{2}{3}f_0\ddd{z}_1$$
$$\ddd{q}_{2,2}=e_1\ddd{p}_{0,2}+\frac{1}{3}(e_0-e_1)\ddd{p}_{0,3}+\frac{2}{3}f_1\ddd{z}_1+\frac{1}{3}f_0\ddd{z}_2.$$
