...
Parametri so določena z enačbama \ref{eq18} in \ref{eq19} na naslednji način. 
Zapišimo enačbo \ref{eq18} kot 
\begin{align*}
...
\end{align*}
Na enak način iz enačbe \ref{eq19} dobimo še parametra $e_1$ in $f_1$
\begin{align*}
...
Če bi imeli robove ploskev izbrane na tak način, da bi veljalo 
