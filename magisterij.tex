...
domenskih trikotnikov. Predpostavljajmo, da bi imeli že vnaprej določene robne 
točke ploskev $\ddd{R}$ in $\ddd{S}$, tako da bi bili robovi dobljenega zlepka 
$C^1$-zvezni. Če bi veljalo 
$$\ddd{s}_{1,0,2}= \alpha_1\ddd{r}_{1,0,2}+\alpha_2\ddd{r}_{0,1,2}+\alpha_3\ddd{r}_{0,0,3}$$
in
$$\ddd{s}_{1,2,0}= \beta_1\ddd{r}_{0,1,2}+\beta_2\ddd{r}_{0,3,0}+\beta_3\ddd{r}_{0,2,1},$$
kjer je $(\alpha_1,\alpha_2,\alpha_3)\neq(\beta_1,\beta_2,\beta_3)$, bi 
bilo nemogoče določiti točki $\ddd{r}_{1,1,1}$ in $\ddd{s}_{1,1,1}$, da bi 
bil dobljeni zlepek $C^1$-zvezen, saj para trikotnikov 
$<\ddd{r}_{1,0,2},\ddd{r}_{0,1,2},\ddd{r}_{0,0,3}>$ in 
$\ddd{s}_{0,1,2},\ddd{s}_{0,0,3},\ddd{s}_{1,0,2}>$ ter 
$<\ddd{r}_{1,2,0},\ddd{r}_{0,3,0},\ddd{r}_{0,2,1}>$ in 
$<\ddd{s}_{0,3,0},\ddd{s}_{0,2,1},\ddd{s}_{1,2,0}>$ 
v tem primeru nista afini sliki istega para domenskih trikotnikov. 
\end{primer}
...
Polinoma vstavimo v enačbo \ref{eq22}. 
\begin{align*}
x
\end{align*}
