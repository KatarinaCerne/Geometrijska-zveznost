...
\todo{povezava med tema dvema deloma? npr. junction functions lahko izberem skoraj
povsem poljubno. zanje veljata le dva pogoja. Prvi pogoj sledi iz zahteve po regularnosti
reparametrizacijske funkcije f}

\todo{def. regularnosti?}
\todo{kaj je lokalna regularnost?}

Reparametrizacijska funkcija je regularna vzdolž $C$, če sta oba njena parcialna odvoda prvega 
...
in ju skušajmo zapisati s pomočjo \todo{junction functions}. Za odvod po spremenljivki $x$ velja:
