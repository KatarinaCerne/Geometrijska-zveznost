...
\end{align*}
kjer $\ddd{n}$ označuje normalo na ravnino, ki jo določajo vektorji $\ddd{q}_{1,0}$, 
...
f_0=\frac{\det[\ddd{p}_{1,0},\ddd{q}_{3,0},\ddd{n}]}{\det[\ddd{p}_{1,0},\ddd{z}_0,\ddd{n}]}.
\end{align*}
...
\begin{align*}
  ...
  f_1=\frac{\det[\ddd{p}_{1,3},\ddd{q}_{2,3},\ddd{n}]}{\det[\ddd{p}_{1,3},\ddd{z}_2,\ddd{n}]}.
\end{align*}
