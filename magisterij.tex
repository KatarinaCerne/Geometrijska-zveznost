...
\section{Konctrukcija $G^1$-zveznih trikotnih Bézierjevih ploskev}

\subsection{Trikotne Bézierove ploskve}
...
nad trikotno domeno. Ko imamo opravka s trikotnimi domenami, uporaba običajnega 
...
\begin{definicija}
  \emph{Trikotna Bézierov ploskev stopnje n} je podana s parametrizacijo
...
\todo{lastnosti trikotniškega razcveta?}



\subsection{Primeri konstrukcije $G^1$-zveznih trikotnih Bézierovih ploskev}
