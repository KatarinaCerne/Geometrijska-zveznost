...
% \caption[caption za v kazalo]{Dolg caption pod sliko}
  \caption[V vozlišču]{$G^1$-zvetnost v vozlišču}
  \label{fig:vvozliscu}
\end{figure}
...
\end{align}
med preostalimi kontrolnimi točkami pa mora veljati zveza 
\begin{align}\label{eq65}
\todo{formula}
\end{align}

Izmed enačb \eqref{eq61}-\eqref{eq65} nam tiste, v katerih se točka $\ddd{P}$ ne pojavi, ne 
prinesejo nobenih dodatnih pogojev, obravnavamo jih enako kot v poglavju \ref{g1primeri}. 
Pogoje, ki jih dobimo iz enačb \eqref{eq65} pri \todo{vrednost}, 
