...
Enačbi \eqref{eq54} in \eqref{eq55} nam data prvi sklop pogojev, ki morajo veljati 
za ploskve $\ddd{X}_i$ in njihove \todo{junction} funkcije. Te pogoje si oglejmo 
...
za kontrolne točke veljati zveza 
