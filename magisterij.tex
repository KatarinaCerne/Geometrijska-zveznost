...
\alpha_i(v_i)\frac{\partial}{\partial u_{i+1}}\ddd{X}_{i+1}(u_{i+1},0)+
\beta_i(v_i)\frac{\partial}{\partial v_{i+1}}\ddd{X}_{i+1}(u_{i+1},0)
\end{align}
za $i=1,\ldots, N-1$ ter 
\begin{align}\label{eq53}
  \frac{\partial}{\partial u_N}\ddd{X}_N(0,v_N)=
  \alpha_i(v_N)\frac{\partial}{\partial u_1}\ddd{X}_1(u_1,0)+
  \beta_i(v_N)\frac{\partial}{\partial v_1}\ddd{X}_1(u_1,0).
\end{align}
V točki $\ddd{P}$ mora torej veljati 
\begin{align}\label{eq54}
  \frac{\partial}{\partial u_i}\ddd{X}_i(0,0)=
  \alpha_i(v_i)\frac{\partial}{\partial u_{i+1}}\ddd{X}_{i+1}(0,0)+
  \beta_i(v_i)\frac{\partial}{\partial v_{i+1}}\ddd{X}_{i+1}(0,0)
\end{align}
za $i=1,\ldots, N-1$ ter 
\begin{align}\label{eq55}
  \frac{\partial}{\partial u_N}\ddd{X}_N(0,0)=
  \alpha_i(v_N)\frac{\partial}{\partial u_1}\ddd{X}_1(0,0)+
  \beta_i(v_N)\frac{\partial}{\partial v_1}\ddd{X}_1(0,0).
\end{align}
...
\alpha_i(0)\frac{\partial^2}{\partial u_{i+1}^2}\ddd{X}_(0,0) + 
\alpha_i'(0)\frac{\partial}{\partial u_{i+1}}\ddd{X}_{i+1}(0,0) +\\ 
&+\beta_i(0)\frac{\partial}{\partial v_{i+1}}\ddd{X}_{i+1}(0,0) + 
\beta_i'(0)\frac{\partial}{\partial v_{i+1}}\ddd{X}_{i+1}(0,0).
\end{split}
\end{equation}
...
in 
$$\ddd{R}_i=\alpha_i(0)\frac{\partial^2}{\partial u_{i+1}^2}+
\alpha_i'(0)\frac{\partial}{\partial u_{i+1}}\ddd{X}_{i+1}(0,0)+
\beta_i'(0)\frac{\partial}{\partial v_{i+1}}\ddd{X}_{i+1}(0,0)$$
ter zapišimo enačbo \eqref{eq56} v matrični obliki. Naj bo matrika $B$ definirana kot 
$$B = 
\begin{bmatrix}
1 & -\beta_1(0) & 0 & 0 & \cdots & 0\\
0 & 1 & -\beta_2(0) & 0 & \cdots & 0\\
\vdots & & \ddots & \ddots  &  & \vdots\\
0 & \cdots & & 0 & 1 & -\beta_{N-1}(0)\\
-\beta_N(0) & 0 & \cdots & 0 & 0 & 1
\end{bmatrix}.
$$
Potem lahko enačbo \eqref{eq56} zapišemo kot
...
$$B_1 = 
\begin{bmatrix}
1 & -\beta_2(0) & 0 & 0 & \cdots & 0\\
0 & 1 & -\beta_3(0) & 0 & \cdots & 0\\
\vdots & & \ddots & \ddots  &  & \vdots\\
0 & \cdots & & 0 & 1 & -\beta_{N-1}(0)\\
0 &  & \cdots & 0 & 0 & 1
\end{bmatrix}
...
\begin{align*}
\det(B) &= \det(B_1) + (-1)^N(-\beta_N(0))\det(B_2) = 
1 - (-1)^N(-\beta_N(0))\prod_{i=0}^{N-1}(-\beta_i(0)) = \\
&=1 - \prod_{i=0}^N\beta_i(0)
\end{align*}

$\beta_i(0)<0$ --- za lihe $N$ ni 0
...
\vdots & & \ddots & & \vdots\\
0 & \cdots  & 0 & 1 & 0\\
\beta_N(0) & \beta_N(0)\beta_1(0) & \beta_N(0)\beta_1(0)\beta_2(0) & \cdots & 
\beta_N(0)\beta_1(0)\cdots \beta_{N-1}(0)
\end{bmatrix}
$$
...
Zadnja vrstica $CB$ je ničelna. --- sistem bo rešljiv, ko bo tudi zadnja vrstica 
$$C
\begin{bmatrix}
\ddd{R}_1\\
\ddd{R}_2\\
...
\end{bmatrix}
$$ ničelna. 
$\beta_N(0)\ddd{R}_1+\beta_N(0)\beta_1(0)\ddd{R}_2+\cdots + 
\beta_N(0)\beta_1(0)\beta_2(0)\cdots\beta_{N-1}(0)\ddd{R}_N=0.$
