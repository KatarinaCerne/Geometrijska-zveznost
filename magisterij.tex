...
3\sum_{j=0}^2(\ddd{P}_{0,j}-\ddd{P}_{0,j+1})B_j^2(v).$$
...
F_1(v)\sum_{j=0}^2(\ddd{P}_{0,j}-\ddd{P}_{0,j+1})B_j^2(v).
  \end{split}
\end{equation}
...
bomo v nadaljevanju izpeljali na nekoliko drugačen način. Sedaj najprej analizirajmo 
