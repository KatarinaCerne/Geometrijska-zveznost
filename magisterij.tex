...
Če enačbi \eqref{eq52} in \eqref{eq53} odvajamo še po $v_i=u_{i+1}$, in ju evalviramo v $v_i=u_i+1=0$, dobimo 
...
med sabo likearno neodvisne. Zadnja vrstica matrike $CB$ pa je ničelna. Torej je 
