...
%Naj bosta $R: \Omega_1 \subseteq \R^2 \rightarrow \R^3$ in 
...
po spremenljivki $y$ enaki, zato je dovolj, da pri obravnavi 
...
$R=S \circ f$ vzdolž $C$. 
Da imamo na stiku geometrijsko zveznost stopnje $G^1$, more poleg 
pogoja za $G^0$ veljati še $R_x = S_u u_x + S_v v_x$ vzdolž $C$, 
za $G^2$ more poleg pogojev za $G^0$ in $G^1$ veljati še 
