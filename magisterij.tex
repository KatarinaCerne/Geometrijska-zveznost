...
Preden se lotimo definicij geometrijske zveznosti krivulj in ploskev, najprej obnovimo 
nekaj osnovnih pojmov v zvezi s podajanjem krivulj in ploskev. 

Krivulje in ploskve lahko podajamo na različne načine: eksplicitno, implicitno 
ali parametrično. Oglejmo si definicijo parametrično podane krivulje in regularne 
...
$$\mbox{rang}(DF)(u,v)=2 \textrm{ za }(u,v)\in K.$$
\end{definicija}
...
$\frac{df}{dt}(t_1)>0$ \todo{v točki t1 ali povsod?} ter 
\begin{align*}
